...
<form name="myform" class="form-inline definewidth m20" action="del-admin.php" method="post" onsubmit="return check();">
...
if(isset($id))
{
    if($id == 1){echo '<script>alert("严禁删除根用户！！！");</script>' ;}else{
